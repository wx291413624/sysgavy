...
RainyDay.prototype.prepareCanvas = function () {
  ...
  var a = this.img.clientWidth, b = this.img.clientHeight, c = this.img.offsetLeft, d = this.img.offsetTop,
    e = this.canvas.width, f = this.canvas.height, g = this.canvas.offsetLeft, h = this.canvas.offsetTop;
  ...
  var b = Math.max((a.x - this.options.reflectionDropMappingWidth) / this.options.reflectionScaledownFactor, 0),
    ...
    f = Math.max(a.x - 1.1 * a.r, 0), g = Math.max(a.y - 1.1 * a.r, 0);
  ...
  var f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z = this.background.getContext("2d"),
    A = z.getImageData(0, 0, a, b), B = A.data, C = c + 1, D = C * (C + 1) / 2, E = new BlurStack, F = new BlurStack,
    G = E;
